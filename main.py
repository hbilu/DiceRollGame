...
"""
Calculate the chance that you will reach 100th step of the Eiffel Tower under following conditions:
...
# the chance to reach 30th step
print(np.sum(last_steps >= 30)/100000)
